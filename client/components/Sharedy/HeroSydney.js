...
import Container from "../Sharedy/Container.js";
import { Text, LineBreak } from "../Sharedy/Text.js";
import { Display, Subheadline } from "../Sharedy/Headline.js";
...
const Modal = styled.div`
  ...
  ${props =>
    ...
    css`
      opacity: 1;
      transition: opacity ${transition.duration}s ${transition.type}
          ${transition.delay}s,
    ...
    return (
      <Root>
        <Modal isVisible={!this.state.contentIsVisible}>
          <ModalClose onClick={this.closeModal} href="#">
            &times;
          </ModalClose>
        ...
        <FullBoxHeight>
          <CoverImage
            homeSydney
            src="http://res.cloudinary.com/pw-img-cdn/image/upload/v1504164089/home-sydney_qrh7b8.jpg"
          />

          <Container mw="sm" textCenter relative pt={[4, 4, 5, 5, 6]}>
            <Subheadline color="brandAlt" children="Dependable and effective" />
            <Display color="brandAlt">
              We help make Sydney{" "}
              <LineBreak bp="1" m="auto">
                strata living great.
              </LineBreak>
            </Display>
            <Text color="text" mb={3} mx="auto" w={[1, 10 / 12]}>
              We know that our job is much more that just looking after
              buildings. Its the people that matter.{" "}
