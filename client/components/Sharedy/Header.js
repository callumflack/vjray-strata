...
import { IconPhone } from "../Sharedy/Icons";
import Icon from "../Sharedy/Icon";
import { Display } from "../Sharedy/Headline";
import { Text, InlineText, Divider } from "../Sharedy/Text";
...
const Root = styled(Flex)`
  ...
  transition: opacity ${fade.duration}s ease-in-out ${fade.delay}s,
...
const MobileModal = Flex.extend`
  opacity: 1;
  transform: translateY(0);
  transition: opacity ${fade.duration}s ease-in-out, transform 0s ease-in-out 0s;
...
class Header extends React.Component {
  ...
  render() {
    return (
      <div>
        <Root isHidden={!this.state.isVisible} {...this.state}>
          <Container px={[1, 2, 2, 3]} mw="lg" w={1}>
            <Flex align="center" justify="space-between">
              <DesktopNav hideAtMobile style={{ textAlign: "center" }}>
                <Nav>
                  ...
                  <Link href="/what-we-do-for-you">
                    <a>
                      <LinkText
                        isActive={this.props.pathname === "/what-we-do-for-you"}
                      >
                        What We Do For You
                      </LinkText>
                    </a>
              ...
              <ResponsiveToggle hideAtDesktop p={2}>
                <Hamburger
                  onClick={this.handleModalTriggerClick}
          ...
          <MobileNav>
            <MobileNavContainer textCenter>
              <MobileNavFlex column isVisible={this.state.isModalVisible}>
                ...
                <Link href="/who-we-are">
                  <a>
                    <MobileLinkText>Who we are</MobileLinkText>
                  </a>
                </Link>
                <Link href="/what-we-do-for-you">
                  <a>
                ...
                <Link href="/let-us-help-you">
                  <a>
                    <Text align="left" font="textRegular" mt={1}>
                      <StyledButton invert icon="true" children="Get a fast quote" />
                    </Text>
                  </a>
                </Link>
              </MobileNavFlex>
