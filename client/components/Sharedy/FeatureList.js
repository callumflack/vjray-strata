...
import { Text, SmallText, LargeText } from "../Sharedy/Text";
...
const StyledIcon = props => <Icon color="brand" size="90" icon={props.icon} />;
...
const Divider = () => (
  <RootDivider>
    <Text font="displayLight" fontSize={[6, 7]} color="brand" mx={2}>
      +
    </Text>
  </RootDivider>
);
  ...
  <Box w={[5 / 6, 5 / 6, 5 / 6, 1]} mx="auto" mt={[2, 2, 2, 3]}>
    <Box mx={-3}>
      ...
      <StyledGrid>
        ...
        <Lede>
          Stay because you're happy, not because you're stuck with us.
        </Lede>
      </StyledGrid>
      ...
      <StyledGrid>
        ...
        <Lede>
          We're open Saturdays, because not everyone has time in work hours.
        </Lede>
      </StyledGrid>
      ...
      <StyledGrid>
        ...
        <Lede>
          Emergencies happen. Speak to one of our senior staff anytime.
        </Lede>
      </StyledGrid>
    </Box>
  </Box>
