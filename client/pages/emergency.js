  ...
  <Layout>
    ...
    <Block mw="sm">
      ...
      <Text mb={4} color="text70">
        In the case of a natural disaster such as a major storm or flood, please
      ...
      <LargeText
        font="displayMedium"
        mb={1}
        children="Is it a rental property?"
      />
      <Text mb={2} color="text70">
        If your repair relates to a property that you are renting through one of
      ...
      <Text mb={4} color="text70">
        If you are renting your property through another agent, other than VJ
        Ray you should report the problem directly to your rental agent.
      </Text>

      <LargeText
        font="displayMedium"
        mb={1}
        children="Is it a non-urgent issue?"
      />
      <Text color="text70">
      ...
      <LargeText
        font="displayMedium"
        mb={1}
        children="Is it within business hours?"
      />
      <Text color="text70" mb={2}>
        If your repair is urgent and the time is currently office hours, please
      ...
      <Text color="text70" mb={4}>
        Please don't rely on an email for an urgent repair as your strata
      ...
      <Text color="text70">
        Remember, our business hours include Saturdays until 4pm (2pm at our
