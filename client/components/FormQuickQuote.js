...
import { BoxedSubheadline } from "./Shared/Headline";
import LaddaButton from "./Shared/LaddaButton";
...
const Inputs = styled(Flex)`
  ...
  @media (min-width: 700px) {
    margin: auto;
    max-width: ${theme.breakpoints[1]}em;
  }
...
const Input = hoc("input").extend`
  ...
  font-family: ${theme.families.textBook};
  flex-grow: 1;
