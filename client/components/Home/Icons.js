...
const IconSun = function IconSun(props) {
  ...
  return (
    <svg Style xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" aria-labelledby="title">
...
const IconContact = function IconContact(props) {
  const fill = props.fill || theme.colors.brand

  return (
    <svg Style xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-labelledby="title">
      <title id="title">Sun</title>
      <path fill="none" d="M0 0h24v24H0z"/>
      <path fill={fill} d="M22 18V3H2v15H0v2h24v-2h-2zm-8 0h-4v-1h4v1zm6-3H4V5h16v10z"/>
    </svg>
  )
}
