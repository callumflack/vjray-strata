...
import { LargeText, LineBreak, LineBreakAll } from "../Sharedy/Text";
...
const HeroFacts = props => (
  <StyledHeroBox>
    <HeroContainer mw="sm">
      <HeroFlex>
        <HeroTitleBox width={[2 / 3, 1, 2 / 3, 2 / 3]} ml={0} mb={[3, 4]}>
          ...
          <LargeText color="text70">
            ...
            <LineBreak>to help your Strata Management.</LineBreak>
          </LargeText>
        </HeroTitleBox>
      </HeroFlex>
    </HeroContainer>
